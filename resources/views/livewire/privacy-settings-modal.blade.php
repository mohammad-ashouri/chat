    ...
    @if($showModal)
        <div
            ...
            <div
                ...
                <div class="mt-3">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 mb-4">تنظیمات حریم
                        خصوصی</h3>

                    <div class="mt-2 px-7 py-3">
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="showOnlineStatus"
                        ...
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="showLastSeen"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="showReadReceipts"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="showTypingStatus"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
