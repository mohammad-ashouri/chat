            ...
            <div
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2 px-7 py-3">
                        <div class="mb-4">
                            <label for="twoFactorMethod"
                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">روش احراز هویت دو
                                مرحله‌ای</label>
                            <select id="twoFactorMethod" wire:model="twoFactorMethod"
                                ...
                                <option value="authenticator">برنامه احراز هویت</option>
                            </select>
                        </div>

                        <div class="mb-4">
                            <label for="loginAttempts"
                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">تعداد تلاش‌های
                                مجاز ورود</label>
                            <select id="loginAttempts" wire:model="loginAttempts"
                                    class="mt-1 block w-full px-3 py-2 border dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-4">
                            <label for="lockoutDuration"
                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">مدت زمان قفل شدن
                                حساب</label>
                            <select id="lockoutDuration" wire:model="lockoutDuration"
                                    class="mt-1 block w-full px-3 py-2 border dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">به خاطر سپردن دستگاه</span>
                            </label>
                        </div>

                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="loginNotifications"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
                                <span class="text-gray-700 dark:text-gray-300">اعلان ورود به حساب</span>
                            </label>
                        </div>

                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="deviceManagement"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
                                <span class="text-gray-700 dark:text-gray-300">مدیریت دستگاه‌ها</span>
                            </label>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="flex items-center space-x-3 space-x-reverse">
                                <input type="checkbox" wire:model="sessionTimeout"
                                       class="form-checkbox h-5 w-5 text-blue-600 dark:text-blue-500">
                                <span class="text-gray-700 dark:text-gray-300">خروج خودکار پس از مدتی عدم فعالیت</span>
                            </label>
                        </div>
                    </div>
