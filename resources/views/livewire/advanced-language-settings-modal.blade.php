                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <div class="mb-4">
                            <label for="numberFormat"
                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">فرمت اعداد</label>
                            <select id="numberFormat" wire:model="numberFormat"
                                    class="mt-1 block w-full px-3 py-2 border dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-4">
                            <label for="currencyFormat"
                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">فرمت ارز</label>
                            <select id="currencyFormat" wire:model="currencyFormat"
                                    class="mt-1 block w-full px-3 py-2 border dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-4">
                            <label for="timezone" class="block text-sm font-medium text-gray-700 dark:text-gray-300">منطقه
                                زمانی</label>
