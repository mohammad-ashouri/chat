...
<div>
    <x-modal :name="$name" :show="$show" maxWidth="2xl">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <button type="button" class="text-gray-400 hover:text-gray-500"
                        wire:click="$dispatch('close-modal', { name: '{{ $name }}' })">
            ...
            @if($isAdmin)
                            ...
                            <div wire:click="toggleUser({{ $user->id }})"
                                ...
                                <div class="flex items-center h-5 ml-3">
                                    <input type="checkbox"
                                        ...
                                        @checked(in_array($user->id, $this->selectedUsers))>
                                </div>
                                @if($user->profile_photo_url)
                                    <img src="{{ $user->profile_photo_url }}" alt="{{ $user->name }}"
                ...
                <div class="mt-6 flex justify-end space-x-4 gap-2">
                    <x-danger-button wire:click="$dispatch('open-modal', { name: 'delete-group-confirmation' })">
                        حذف گروه
                    </x-danger-button>
    ...
    <x-modal name="success-modal" maxWidth="sm">
        <div class="p-6">
            ...
            <div class="text-center">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">تغییرات با موفقیت ذخیره شد</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">تغییرات اعمال شده در گروه با موفقیت ذخیره
                    شدند.</p>
                <x-primary-button wire:click="closeSuccessModal">
                    بستن
                </x-primary-button>
            </div>
        </div>
    ...
    <x-modal name="delete-group-confirmation" maxWidth="sm">
        <div class="p-6">
            <div class="flex items-center justify-center mb-4">
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <x-secondary-button wire:click="$dispatch('close-modal', { name: 'delete-group-confirmation' })">
                        انصراف
                    </x-secondary-button>
